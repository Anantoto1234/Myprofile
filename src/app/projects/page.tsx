...
export default function ProjectsPage() {
    ...
    return (
        <div className="mx-auto container max-w-7xl px-4 md:px-8 lg:px-12 py-12 md:py-20">
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mb-6 flex flex-wrap items-center gap-3">
                    ...
                    {filter !== "all" && (
                        <Badge className="flex items-center gap-2 bg-gray-100 text-gray-800">
                            ...
                            <button onClick={() => setFilter("all")} className="text-gray-500 hover:text-gray-700">
                                <X className="h-3 w-3" />
                            </button>
                        </Badge>
                    )}
            ...
            {/* Project Count Info */}
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mb-6 text-sm">
                ...
                <div className="mb-5">
                    <div className="flex flex-wrap gap-2">
                        {project.technologies.slice(0, 4).map((tech) => (
                            <span
                                key={tech}
                                className="text-xs bg-rose-100 px-3 text-black py-1 rounded-full"
                            >
                                {tech}
                            </span>
                        ))}
